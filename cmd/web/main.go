...
func main() {
	...
	flag.StringVar(&app.config.dsn, "dsn", "mariadb:myverysecretpassword@tcp(localhost:12345)/breeders?parseTime=true&tls=false&collation=utf8_unicode_ci&timeout=5s", "mysql DSN")
	flag.Parse()
